...
from routes.sim_week import build_sim_router  # noqa: E402
build_sim_router(api_router=api_router, db=db,
                 get_current_user=get_current_user,
                 require_role=require_role)
...
from routes.growth_copilot import build_growth_copilot_router  # noqa: E402
api_router.include_router(build_growth_copilot_router(
    db=db,
    get_current_user=get_current_user,
    require_role=require_role,
))
...
from routes.arcade_solo import build_arcade_solo_router  # noqa: E402
api_router.include_router(build_arcade_solo_router(
    db=db,
    get_current_user=get_current_user,
))
...
from routes.truck_cleaning_brochure import build_truck_cleaning_brochure_router  # noqa: E402
api_router.include_router(build_truck_cleaning_brochure_router(
    db=db,
    require_role=require_role,
))

from routes.truck_cleaning_crew import build_truck_cleaning_crew_router  # noqa: E402
api_router.include_router(build_truck_cleaning_crew_router(
    db=db,
    require_role=require_role,
))

from routes.carrier_search import build_carrier_search_router  # noqa: E402
api_router.include_router(build_carrier_search_router(
    db=db,
    require_role=require_role,
))
...
# Mount MN Niche Market Network (10-vertical shipper acquisition machine)
from routes.niche_markets import build_niche_markets_router  # noqa: E402
api_router.include_router(build_niche_markets_router(
    db=db,
    get_current_user=get_current_user,
))

...
SERVICE_STANDARD = [
    ...
    {"want": "Real-time visibility", "commitment": "Free shipper portal with live GPS on every load — you see \"47 miles out, ETA 3:22 PM\", not \"in transit\". ETAs, documents and POD land in your portal within the hour.", "target": "Live GPS 100% of loads · POD ≤ 1 hr", "metric": "visibility"},
    ...
    {"want": "Painless claims", "commitment": "Cargo liability PLUS contingent carrier insurance on every load — if a carrier's policy fails, ours doesn't. Claims acknowledged in 24 hours, resolved target 30 days, funded reserve behind it.", "target": "Dual-insured · Ack ≤ 24h · resolve ≤ 30 days", "metric": "claims"},

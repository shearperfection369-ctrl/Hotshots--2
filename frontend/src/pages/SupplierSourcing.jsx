...
import { Factory, ShieldAlert, Search, MapPin, Clock, TrendingUp, AlertTriangle, DollarSign } from "lucide-react";
...
export default function SupplierSourcing() {
  ...
  useEffect(() => { api.get("/suppliers").then(({ data }) => setData(data)); }, []);

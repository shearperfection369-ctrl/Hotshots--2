...
import { Zap, Copy, ExternalLink, FileText, Users } from "lucide-react";
      ...
      <div className="p-4 md:p-6 space-y-5" data-testid="hotshot-sales-page">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="p-4 bg-slate-950/60 border-amber-500/30">
            ...
            <div className="text-[10px] text-slate-500 mt-3">Demo video: record a 5–10 min screen capture (Load Hunter + Triage + a fast sandbox month) and I'll wire it into the landing page.</div>
          </Card>

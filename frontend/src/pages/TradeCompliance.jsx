      ...
      <div className="p-4 md:p-6 grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-5">
        ...
        <div className="space-y-5">
          <DraggableTiles
            ...
            defaultOrder={SECTIONS.map((s) => s.id)}
            tiles={{
              summary: { label: "Overview", render: () => (
              ...
              incoterms: { label: "Incoterms 2020", render: () => (
              ...
              tariffs: { label: "Tariff Schedules", render: () => (
              ...
              section301: { label: "Section 301", render: () => (
              ...
              section232: { label: "Section 232", render: () => (
              ...
              watchlists: { label: "Watchlists & Sanctions", render: () => (
              ...
              broker: { label: "Broker / ACE", render: () => (
              ...
              regs: { label: "Key Regulations", render: () => (
              ...
              links: { label: "Quick Links", render: () => (
